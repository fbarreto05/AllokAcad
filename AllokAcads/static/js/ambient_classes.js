document.addEventListener('DOMContentLoaded', function() {
    ...
    function setupDeleteConfirmation() {
        ...
        deleteButtons.forEach(button => {
            button.addEventListener('click', function(e) {
                ...
                const className = this.closest('.class-item')
                    ?.querySelector('.class-name')?.textContent || 'esta turma';
                ...
                showConfirmModal(
                    ...
                    'Esta ação não pode ser desfeita. Todos os dados relacionados a esta turma serão permanentemente removidos.',
                    'error',
                    () => {
    ...
    if (!document.querySelector('#ambient-classes-styles')) {
        const styles = document.createElement('style');
        styles.id = 'ambient-classes-styles';
        styles.textContent = `
            @keyframes fadeIn {
                from {
                    opacity: 0;
