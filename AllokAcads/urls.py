...
urlpatterns = [
    ...
    path('ambient/resources/classes/edit/<int:classid>/<str:ambientid>/<str:userid>', views.ambient_edit_classes, name='ambient_edit_classes'),
    path('ambient/resources/classes/edit/<int:classid>/validate/<str:ambientid>/<str:userid>', views.ambient_edit_classes_validate, name='ambient_edit_classes_validate'),
    path('ambient/resources/classes/delete/<int:classid>/<str:ambientid>/<str:userid>', views.ambient_delete_classes, name='ambient_delete_classes'),
    ...
    path('ambient/resources/rooms/edit/<int:roomid>/<str:ambientid>/<str:userid>', views.ambient_edit_rooms, name='ambient_edit_rooms'),
    path('ambient/resources/rooms/edit/validate/<int:roomid>/<str:ambientid>/<str:userid>', views.ambient_edit_rooms_validate, name='ambient_edit_rooms_validate'),
    path('ambient/resources/rooms/delete/<int:roomid>/<str:ambientid>/<str:userid>', views.ambient_delete_rooms, name='ambient_delete_rooms'),
    ...
    path('ambient/resources/subjects/edit/<int:subjectid>/<str:ambientid>/<str:userid>', views.ambient_edit_subjects, name='ambient_edit_subjects'),
    path('ambient/resources/subjects/edit/validate/<int:subjectid>/<str:ambientid>/<str:userid>', views.ambient_edit_subjects_validate, name='ambient_edit_subjects_validate'),
    path('ambient/resources/subjects/delete/<int:subjectid>/<str:ambientid>/<str:userid>', views.ambient_delete_subjects, name='ambient_delete_subjects'),
    ...
    path('ambient/resources/formations/edit/<int:formationid>/<str:ambientid>/<str:userid>', views.ambient_edit_formations, name='ambient_edit_formations'),
    path('ambient/resources/formations/edit/validate/<int:formationid>/<str:ambientid>/<str:userid>', views.ambient_edit_formations_validate, name='ambient_edit_formations_validate'),
    path('ambient/resources/formations/delete/<int:formationid>/<str:ambientid>/<str:userid>', views.ambient_delete_formations, name='ambient_delete_formations'),
    ...
    path('ambient/resources/roomtypes/edit/<int:roomid>/<str:ambientid>/<str:userid>', views.ambient_edit_roomtypes, name='ambient_edit_roomtypes'),
    path('ambient/resources/roomtypes/edit/validate/<int:roomid>/<str:ambientid>/<str:userid>', views.ambient_edit_roomtypes_validate, name='ambient_edit_roomtypes_validate'),
    path('ambient/resources/roomtypes/delete/<int:roomid>/<str:ambientid>/<str:userid>', views.ambient_delete_roomtypes, name='ambient_delete_roomtypes'),
    ...
    path('ambient/resources/admtypes/edit/<int:admtypeid>/<str:ambientid>/<str:userid>', views.ambient_edit_admtypes, name='ambient_edit_admtypes'),
    path('ambient/resources/admtypes/edit/validate/<int:admtypeid>/<str:ambientid>/<str:userid>', views.ambient_edit_admtypes_validate, name='ambient_edit_admtypes_validate'),
    path('ambient/resources/admtypes/delete/<int:admtypeid>/<str:ambientid>/<str:userid>', views.ambient_delete_admtypes, name='ambient_delete_admtypes'),
