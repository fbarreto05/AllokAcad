...
class Ambient(models.Model):
    ...
    description = models.TextField(max_length=500, null=True)
    periods_in_a_day = models.IntegerField(null=True, default=0)
    days_in_a_cicle = models.IntegerField(null=True, default=0)
    ...
    max_actv_in_cicle = models.IntegerField(null=True, default=0)
    min_actv_in_cicle = models.IntegerField(null=True, default=0)
    max_actv_in_day = models.IntegerField(null=True, default=0)
    min_actv_in_day = models.IntegerField(null=True, default=0)
